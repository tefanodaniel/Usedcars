$(document).ready(function() {
    ...
    $('#movingtool-map').usmap({
	    'click' : function(event, data) {
            ...
            $('.movingtool-state-input')
                .val(state_clicked);

            /* Test to ensure that class-based jQuery selector above changed individual inputs
                alert("Values for each input: " + 
                $('#movingtool-state-input-listings').attr("value") + " " +
                $('#movingtool-state-input-avgmpg').attr("value") + " " +
                $('#movingtool-state-input-14').attr("value"));
            */

            document.movingtool_listings.submit();
            document.movingtool_avgmpg.submit();
            document.movingtool_14.submit();
